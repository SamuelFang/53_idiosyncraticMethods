      ...
      , String prefix
        ...
        for( int el = 0; el < list.size(); el++){
            ...
            /* 3.  Stumbling block 0
               ...
               This protection is implemented by the ___________compiler (compiler? JVM?)
               The following code violates the restriction:
              */
            // [code that violates the restriction] result +=

            /*
             predicted error message:
                operation cannot be done to _______
            ...
            /* 6. Workaround 1
               ...
               to tell the ___________compiler (compiler? JVM?)
            ...
            /* 7. Stumbling block 2
               ...
               because the ___________jvm (compiler? JVM?)
               objects to the following code that adds use of
               the operator to the code from Stumbling block 0:
             */
